...
const Categories = () => {
    ...
    const category = decodeURIComponent(searchParams.get('category') || ''); //searchParams.get('categories');//

    return (
        <>
            <Link to={`/create?category=${encodeURIComponent(category || '')}`} style={{ textDecoration: 'none' }}>
